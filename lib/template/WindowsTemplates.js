        ...
        element.droppable(
            {
                ...
                drop: function(event, ui) {
                    ...
                    if (!didSplitPane) { // If we split the pane, there is no active tab in the new pane
                        // We are now ready to update. Let's deactivate the active tab in the new pane
                        new_pane.find('.active').each(function(index, element) {
                            element = $(element);
                    ...
                    if (draggable.hasClass('active')) { // Activate a tab in the old window
                        old_pane.find('.nav.nav-tabs li').each(function(index, element) {
                            element = $(element);
