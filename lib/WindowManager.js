...
WM.prototype.splitPaneHelper = function(pane_tree, pane_id, percentage, orientation) {
    ...
    if (pane_tree.panes == undefined) return false;
    if (this.splitPaneHelper(pane_tree.panes.pane1, pane_id, percentage)) return true;
    if (this.splitPaneHelper(pane_tree.panes.pane2, pane_id, percentage)) return true;
